-- Ensure the handle_new_user trigger creates profiles properly
-- First drop the existing trigger and function if they exist
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;
DROP FUNCTION IF EXISTS public.handle_new_user();

-- Create an improved trigger function that creates a complete profile
...
-- Also create a function to complete user profiles after email confirmation
