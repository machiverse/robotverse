-- Fix the ambiguous column reference in complete_user_profile function
...
BEGIN
  ...
  IF existing_profile_id IS NOT NULL THEN
    ...
    UPDATE public.profiles SET
      ...
      phone = COALESCE(NULLIF(trim(p_mobile_number), ''), COALESCE(NULLIF(trim(p_mobile_number), ''), profiles.phone)),
