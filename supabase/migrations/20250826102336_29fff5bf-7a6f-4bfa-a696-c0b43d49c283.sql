...
-- Create policy to allow system to update counts (will be handled by edge function)
...
CREATE TRIGGER update_robot_view_counts_updated_at
  BEFORE UPDATE ON public.robot_view_counts
  FOR EACH ROW
