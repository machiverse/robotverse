                ...
                <CardHeader>
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <Badge variant="secondary" className="text-xs">Views tracking</Badge>
                    </div>
                  </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      {sparePart.specifications && typeof sparePart.specifications === 'object' && !Array.isArray(sparePart.specifications) && Object.keys(sparePart.specifications).length > 0 && (
                        <>
                    ...
                    {sparePart.compatible_robots && sparePart.compatible_robots.length > 0 ? (
                      ...
                      <div className="text-center py-8">
                        ...
                        <p className="text-sm text-muted-foreground mt-4">
                          This part can be used with various robot models. Contact the seller for compatibility confirmation.
                        </p>
                      </div>
                    )}
                  </CardContent>
