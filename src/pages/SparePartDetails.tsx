                    ...
                    <div className="flex items-center gap-4 pt-2">
                      {sparePart.profiles?.average_rating > 0 && (
                        <div className="flex items-center gap-1.5 bg-amber-500/10 border border-amber-500/20 px-3 py-1.5 rounded-full">
                          ...
                          <span className="font-bold text-sm text-amber-400">{Number(sparePart.profiles.average_rating).toFixed(1)}</span>
                          <span className="text-xs text-amber-300/70">({sparePart.profiles.total_reviews} reviews)</span>
                        </div>
                      )}
