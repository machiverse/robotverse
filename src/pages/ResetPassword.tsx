...
const ResetPassword = () => {
  ...
  useEffect(() => {
    const checkRecoverySession = async () => {
      try {
        // Support both query and hash (for all Supabase versions)
        ...
        // Handle token hash for newest API
        ...
        // Handle legacy session tokens in URL
        ...
        // Already has valid recovery session
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>
              ...
              Please request a new link from the sign-in page.
            </CardDescription>
          </CardHeader>
          <CardContent>
