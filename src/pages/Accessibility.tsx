      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">Our commitment to making RobotVerse accessible to everyone</p>
          </div>
          ...
          <Card>
            <CardContent className="prose prose-neutral dark:prose-invert max-w-none p-8">
              ...
              <p>
                RobotVerse is committed to ensuring digital accessibility for all users, including those with
                disabilities. We strive to provide an inclusive experience that enables everyone to access our
                industrial robot marketplace platform with ease and independence.
              </p>

              <h2>Accessibility Standards</h2>
              <p>
                We aim to conform to the Web Content Accessibility Guidelines (WCAG) 2.1 at the AA level. These
                guidelines explain how to make web content more accessible for people with disabilities and create a
                better user experience for everyone.
              </p>

              <h2>Accessibility Features</h2>
              <p>RobotVerse includes the following accessibility features:</p>
              ...
              <p>RobotVerse has been tested with the following assistive technologies:</p>
              <ul>
              ...
              <ul>
                ...
                <li>
                  Complex data visualizations in analytics dashboards are being enhanced with alternative text
                  descriptions
                </li>
              </ul>

              <h2>Browser Support</h2>
              <p>RobotVerse is designed to work with the latest versions of these browsers:</p>
              <ul>
              ...
              <p>Our mobile applications and responsive website include:</p>
              <ul>
              ...
              <p>
                We welcome your feedback on the accessibility of RobotVerse. If you encounter any accessibility barriers
              ...
              <div className="bg-muted p-4 rounded-lg">
                ...
                <p>
                  <strong>Email:</strong> accessibility@robotverse.in
                </p>
                <p>
                  <strong>Phone:</strong> +918610925352
                </p>
                <p>
                  <strong>General Support:</strong> support@robotverse.in
                </p>
                <p>
              ...
              <h2>Response Time</h2>
              <p>
                We aim to respond to accessibility feedback within 2 business days. For urgent accessibility issues that
                prevent you from using critical features, we'll prioritize these requests and respond within 24 hours.
              </p>
              ...
              <p>
                Some content on RobotVerse is provided by third parties (such as user-generated listings and embedded
                videos). We encourage our users to follow accessibility best practices and provide guidance on creating
                accessible content.
              </p>
              ...
              <p>
                This accessibility statement was created on {new Date().toLocaleDateString()} and last reviewed on{" "}
                {new Date().toLocaleDateString()}. We review and update this statement regularly to ensure it remains
