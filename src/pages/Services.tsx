...
const Services = () => {
  ...
  // Build dynamic category list (depends on search + location)
  ...
  // Build dynamic location list (depends on search + category)
              ...
              {filteredServices.map((service) => (
                <Card key={service.id} className="hover:shadow-lg border border-gray-200 bg-white">
                  <CardHeader>
                    ...
                    <Badge className="bg-blue-100 text-blue-800 border border-blue-200">{service.category}</Badge>
                  </CardHeader>
                  <CardContent>
                    ...
                    <Button onClick={() => handleRequestQuote(service)} size="sm" className="mt-4 w-full">
                      Request Quote
                    </Button>
                  </CardContent>
                </Card>
