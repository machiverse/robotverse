      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-card border border-border rounded-lg p-6 mb-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
            ...
            {/* Category Filter (Dynamic, split by comma) */}
          ...
          <>
            ...
            <div className={viewMode === "grid" ? "grid gap-6 md:grid-cols-2 lg:grid-cols-3" : "space-y-4"}>
              {filteredServices.map((service) => (
                <Card key={service.id} className="hover:shadow-xl border border-gray-200 bg-white rounded-xl">
                  <CardHeader className="pb-3">
                    ...
                    <div className="flex flex-wrap gap-1 mt-2">
                      {service.category.split(",").map((cat) => (
                        <Badge key={cat} className="bg-blue-100 text-blue-800 border border-blue-200">
                          {cat.trim()}
                        </Badge>
                      ))}
                    </div>
