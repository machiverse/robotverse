      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold bg-gradient-primary bg-clip-text text-transparent mb-4">Cookie Policy</h1>
          ...
          <Card>
            <CardContent className="prose prose-neutral dark:prose-invert max-w-none p-8">
              ...
              <p>
                ...
                provide you with a better browsing experience by remembering your preferences and improving our
                services.
              </p>

              <h2>How We Use Cookies</h2>
              <p>RobotVerse uses cookies for the following purposes:</p>
              ...
              <ul>
                ...
                <li>
                  <strong>Customer Support:</strong> For chat and help desk functionality
                </li>
              </ul>
              ...
              <h3>Opt-Out Links</h3>
              <p>For third-party cookies, you can often opt out directly:</p>
              <ul>
                <li>
              ...
              <p>
                ...
                reasons. We'll notify you of any significant changes by posting the updated policy on our website.
              </p>
