...
(function(){
  ...
  w.innerHTML=''
   ...
   +'<div id="rv-wa-pop" role="dialog" aria-label="RobotVerse chat">'
   +'<div id="rv-wa-head"><div class="rv-av">RV</div><div><b>RobotVerse</b><span>Online • Typically replies instantly</span></div><button id="rv-wa-close" aria-label="Close">&times;</button></div>'
   +'<div id="rv-wa-body"><div id="rv-wa-msg">\\ud83d\\udc4b Hello! I\\u2019m RobotVerse Assistant.\\n\\nI can help you with:\\n\\u2022 Robots &amp; cobots\\n\\u2022 Spare parts &amp; EOAT\\n\\u2022 Services &amp; integrators\\n\\u2022 Auctions, logistics &amp; finance\\n\\nHow can I help you today?</div></div>'
