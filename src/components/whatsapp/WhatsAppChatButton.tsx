...
const WhatsAppChatButton: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="relative w-14 h-14 rounded-full bg-[#25D366] text-white shadow-lg shadow-black/20 hover:shadow-lg transition-all duration-300 hover:scale-110 flex items-center justify-center">
