          ...
          <div className="flex items-center space-x-1">
            ...
            <Link to="/ai-assistant" className="hidden sm:flex">
              ...
              >
                ...
                <span className="hidden lg:inline">RobotVerse</span>
              </Button>
            </Link>
            ...
            <div className="relative hidden sm:block" ref={compareDropdownRef}>
              ...
              >
                ...
                <span className="sr-only">
                  Compare ({comparisonCount}/{maxRobots})
                </span>
              </Button>
                  ...
                  <div className="p-4">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-xs text-muted-foreground">
                        {comparisonCount}/{maxRobots} selected
                      </span>
                    </div>
          ...
          <div className="container mx-auto px-4 lg:px-6">
            <div className="flex items-center justify-between">
                      ...
                      <div className="px-6 py-3 border-t border-border/50 bg-muted/20 flex items-center justify-between">
                        <div className="flex items-center gap-4 text-xs text-muted-foreground">
                          <span className="flex items-center gap-1.5">
                            ...
                            {NAVIGATION_CONFIG.spares.categories.reduce(
                              (acc, cat) =>
                                acc + cat.subcategories.reduce((subAcc, sub) => subAcc + sub.componentTypes.length, 0),
                              0,
                            )}
                            + Components
                          </span>
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground">
                                Transport solutions for industrial equipment
                              </p>
                            </div>
                          </div>
                          <Link
              ...
              <div className="flex-1">
                <Link to="/robot-talent" className="nav-item flex items-center justify-center gap-2 w-full">
