  ...
  return (
    <>
      ...
      {!isOpen && (
        ...
        >
          <div className="relative w-14 h-14 rounded-full bg-primary/5 text-primary-foreground shadow-lg shadow-primary/25 hover:shadow-lg hover:shadow-primary/30 transition-all duration-300 hover:scale-110 flex items-center justify-center">
