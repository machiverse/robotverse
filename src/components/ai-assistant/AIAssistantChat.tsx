...
import { Send, Square, Trash2, Bot, User, LogIn, Sparkles, Clock, MessageSquare, Minimize2, X, ArrowLeft } from 'lucide-react';
    ...
    <div className={cn(
      ...
      <div className="flex items-center justify-between px-5 py-3.5 bg-gradient-to-r from-primary/15 via-primary/10 to-primary/5 border-b border-border/40 backdrop-blur-sm">
        ...
        <div className="flex items-center gap-2">
          ...
          {fullPage && (
            <Button variant="ghost" size="icon" className="h-8 w-8 rounded-lg hover:bg-muted relative z-20" onClick={() => navigate('/')} title="Close">
              <X className="w-4 h-4" />
            </Button>
          )}
        </div>
