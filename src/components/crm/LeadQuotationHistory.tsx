...
const STATUS_CONFIG: Record<string, { label: string; color: string; icon: React.ReactNode }> = {
  ...
  sent: { label: "Sent", color: "bg-primary/10 text-primary dark:bg-primary/30 dark:text-primary", icon: <Send className="h-3.5 w-3.5" /> },
  viewed: { label: "Viewed", color: "bg-primary/10 text-primary dark:bg-primary/30 dark:text-primary", icon: <Eye className="h-3.5 w-3.5" /> },
  accepted: { label: "Accepted", color: "bg-success/10 text-success dark:bg-success/30 dark:text-success", icon: <CheckCircle className="h-3.5 w-3.5" /> },
